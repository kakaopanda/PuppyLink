...
public enum CommonCode {
	...
	SELECT_BOARD_RECENT(2120, "가장 최근에 작성된 게시글의 번호를 반환하였습니다."),
	SELECT_BOARD_INFINITE(2121, "무한 스크롤 게시글 조회가 완료되었습니다."),
	SELECT_BOARD_HISTORY(2122, "사용자가 작성한 게시글 목록 조회가 완료되었습니다."),
	SELECT_BOARD_LIKE(2123, "특정 게시글을 좋아요한 사용자 목록 조회가 완료되었습니다."),
	CREATE_BOARD(2124, "게시글 작성이 완료되었습니다."),
	UPDATE_BOARD(2125, "게시글 수정이 완료되었습니다."),
	DELETE_BOARD(2126, "게시글 삭제가 완료되었습니다."),
	LIKE_BOARD(2127, "게시글에 대한 좋아요가 완료되었습니다."),
	SELECT_COMMENT_ONE(2128, "게시글에 작성된 단일 댓글 조회가 완료되었습니다."),
	SELECT_COMMENT_ALL(2129, "게시글에 작성된 댓글 목록 조회가 완료되었습니다."),
	CREATE_COMMENT(2130, "댓글 작성이 완료되었습니다."),
	UPDATE_COMMENT(2131, "댓글 수정이 완료되었습니다."),
	DELETE_COMMENT(2132, "댓글 삭제가 완료되었습니다."),
	SELECT_PIC(2133, "게시글 사진 조회가 완료되었습니다."),
