...
public enum CommonCode {
	...
	SELECT_BOARD_RECENT(2118, "가장 최근에 작성된 게시글의 번호를 반환하였습니다."),
	SELECT_BOARD_INFINITE(2119, "무한 스크롤 게시글 조회가 완료되었습니다."),
	CREATE_BOARD(2120, "게시글 작성이 완료되었습니다."),
	UPDATE_BOARD(2121, "게시글 수정이 완료되었습니다."),
	DELETE_BOARD(2122, "게시글 삭제가 완료되었습니다."),
	LIKE_BOARD(2123, "게시글에 대한 좋아요가 완료되었습니다."),
	SELECT_COMMENT_ONE(2124, "게시글에 작성된 단일 댓글 조회가 완료되었습니다."),
	SELECT_COMMENT_ALL(2125, "게시글에 작성된 댓글 목록 조회가 완료되었습니다."),
